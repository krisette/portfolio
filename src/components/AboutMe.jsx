  ...
  return (
    <Element name="aboutme">
      <motion.div
        ...
        style={{ y }}
        className="flex flex-col md:flex-row lg:flex-row xl:flex-row justify-center items-center">
          <div className="flex items-center justify-center text-white h-full md:h-5/6 ml-5 mr-5 md:m-5 lg:m-5 xl:m-5">
            {/* picture here */}
          </div>
        <div className="flex flex-col items-center m-10 md:w-1/3 lg:w-1/2 xl:w-1/2 lg:text-xl xl:text-xl">
          ...
          <p className="text-gray-50 mb-5">In my spare time, I like playing video games, watching anime/TV/movies, and trying new restaurants. I also love Disney theme parks; it's my goal to go to every single Disney park in the world. (If you're wondering, I'm currently 3/7: I've been to Disneyland, Disney World, and Tokyo Disney so far.)</p>
